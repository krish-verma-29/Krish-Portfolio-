...
// --- GENERIC TYPEWRITER (scroll pe trigger hota hai, sirf ek baar) ---

function runTypewriter(el) {
    const fullText = el.getAttribute('data-typetext');
    const speed = parseInt(el.getAttribute('data-speed')) || 45;
    el.textContent = '';
...
document.querySelectorAll('.type-target').forEach(el => {
    el.setAttribute('data-typetext', el.textContent);
    el.textContent = '';
